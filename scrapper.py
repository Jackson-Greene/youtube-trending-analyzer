...
#/html/body/ytd-app/div/ytd-page-manager/ytd-browse/ytd-two-column-browse-results-renderer/div[1]/ytd-section-list-renderer/div[2]/ytd-item-section-renderer[1]/div[3]
...
for content in soup.findAll("div", class_= "yt-lockup-content"):
    try:
        ...
        description = None
 """
#print(soup.find("html").find("body").findAll("ytd-app"))

#print(soup.find("html").find("body").find("ytd-app"))#.find("div").find("ytd-page-manager").find("ytd-browse").find("ytd-two-column-browse-results-renderer").findAll("div")[1].findAll("ytd-section-list-renderer").findAll("div")[2].findAll("ytd-item-section-renderer")[1])